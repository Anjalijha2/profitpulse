...
import { listProjects, getProject, createProject, updateProject, getProjectProfitability, getProjectBurnRate, deleteProject } from '../controllers/project.controller.js';
...
router.delete('/:id', authorizeRole('projects', 'write'), deleteProject);
